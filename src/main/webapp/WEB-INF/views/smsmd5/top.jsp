...
<div id="toolbar">
    <div class="form-inline" role="form">
        <div class="btn-group">
            <button id="md5Sort" onclick="sortTable(this,1)" class="btn btn-success">MD5排行</button>
            <button id="phoneSort" onclick="sortTable(this,2)" class="btn btn-default">手机号排行</button>
        </div>
    </div>
</div>
<style>
